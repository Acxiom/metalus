...
// TODO [2.0 Review] Make sure we can handle all test cases with new model
class PipelineDependencyExecutorTests extends AnyFunSpec with BeforeAndAfterAll with Suite {
...
//      val resultMap = PipelineDependencyExecutor.executePlan(ApplicationUtils.createPipelineContext(application, None, SparkTestHelper.sparkConf, listener))
...
//      PipelineDependencyExecutor.executePlan(ApplicationUtils.createPipelineContext(application, None, SparkTestHelper.sparkConf, listener))
//      results.validate()
//    }
//
...
//      PipelineDependencyExecutor.executePlan(ApplicationUtils.createPipelineContext(application, None, SparkTestHelper.sparkConf, listener), List("1"))
//      results.validate()
//    }
//
...
//      val resultMap = PipelineDependencyExecutor.executePlan(ApplicationUtils.createPipelineContext(application, None, SparkTestHelper.sparkConf))
//      assert(resultMap.isDefined)
...
//        PipelineDependencyExecutor.executePlan(ApplicationUtils.createPipelineContext(application, None, SparkTestHelper.sparkConf))
//      }
