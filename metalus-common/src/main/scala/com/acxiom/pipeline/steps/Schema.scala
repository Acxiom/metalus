...
object Attribute {
  ...
  def apply(name: String, dataType: AttributeType): Attribute = Attribute(name, dataType)

  def apply(name: String, dataType: String): Attribute = Attribute(name, AttributeType(dataType))
}
